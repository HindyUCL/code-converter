#!/usr/bin/env python3
"""
Setup script for Code Converter
"""
...
def read_readme():
    ...
    if os.path.exists(readme_path):
        with open(readme_path, 'r', encoding='utf-8') as f:
            return f.read()
    return "Code Converter - Convert files and folders into machine-readable format"
...
setup(
    name="code-converter",
    version="1.0.0",
    author="Code Converter Team",
    author_email="codeconverter@example.com",
    ...
    entry_points={
        "console_scripts": [
            "code_converter=code_converter.cli:main",
        ],
    },
